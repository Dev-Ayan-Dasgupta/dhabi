...
class AccountDetailsArgumentModel {
  ...
  @override
  String toString() {
    return 'AccountDetailsArgumentModel(flagImgUrl: $flagImgUrl, accountNumber: $accountNumber, currency: $currency, accountType: $accountType, balance: $balance, iban: $iban, displayStatementList: $displayStatementList, isRetail: $isRetail)';
  }
